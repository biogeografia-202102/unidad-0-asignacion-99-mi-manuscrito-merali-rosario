...
Estos sitios presentan contribucion a la diversidad beta por la incidencia de algunas variables ambientales (habitat, y variables numericas...)(ver figura \ref{fig:Sitios_variables_ambientales} y \ref{fig: mapas_variables_ambientales_nominales}).
  
  
  
![Mapa de los citios segun las variables ambientales numericas \label{fig:Sitios_variables_ambientales}](Sitios_variables_ambientales.png){width=100%}
