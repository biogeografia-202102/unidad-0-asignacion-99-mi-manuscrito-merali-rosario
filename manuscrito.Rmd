...
![Correlacion entre diversidad/equidad y algunas de las variables ambientales \label{fig:correlacion_diversidad_equidad}](correlacion_diversidad_equidad.png){width=50%}
...
Se observa que las variables nitrógeno, fósforo y pH aportan la mayor parte de la varianza explicada. La relación entre las variables se encuentra debidamente representada en el recuadro del escalamiento 2, por medio delos ángulos que forman sus vectores (ver figura \ref{fig:Biplot_PCA_escalamiento}).
  ...
  ![Biplots generados en el PCA de las viariables de suelo \label{fig:Biplot_PCA_escalamiento}](Biplot_PCA_escalamiento.png){width=100%}
...
con el resto de las especies (ver figura \ref{fig:PCA_comunidad}).
  ...
  ![Biplots generados en el PCA de las viariables de suelo \label{fig:PCA_comunidad}](PCA_comunidad.png){width=100%}
...
Sapotaceae (ver figura \ref{fig:Analisis_de_correspondencia}).
  ...
  ![Biplot del analisis de correspondencia de los datos de abundancia de las especies de Sapotaceae \label{fig:Analisis_de_correspondencia}](Analisis_de_correspondencia.png){width=100%}
...
(ver figura \ref{fig:PCoA _promedios_especies}).
  ...
  ![PCoA con promedios ponderados de especies \label{fig:PCoA _promedios_especies}](PCoA _promedios_especies.png){width=100%}
  
(ver figura \ref{fig:Abundancia_matriz}).
  
  
  
  ![Abundancia de especies (matriz de comuniddad transformada) \label{fig:PCoA _promedios_especies}](Abundancia_matriz.png){width=100%}
